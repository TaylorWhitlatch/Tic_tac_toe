...
console.log(player1Wins)
	document.getElementById('wins1').innerHTML = "Wins: " + player1Wins
	document.getElementById('wins2').innerHTML = "Wins: " + player2Wins
	gameOver = true;
...
function myFunction() {
    ...
    document.getElementById("A2").classList.remove("winning-square")
    document.getElementById("B2").classList.remove("winning-square")
    document.getElementById("C2").classList.remove("winning-square")
    document.getElementById("A3").classList.remove("winning-square")
